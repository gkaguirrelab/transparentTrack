...
ellipseArrayMontageFileName = fullfile(pathParams.dataOutputDirFull, [pathParams.runName '_sceneDiagnosticMontage.png']);
...
switch p.Results.videoTypeChoice
    ...
    case 'LiveTrackWithVTOP_eye'
        funCalls = {...
            ...
            '''sceneDiagnosticPlotFileName'', sceneDiagnosticPlotFileName,'...
            '''ellipseArrayMontageFileName'', ellipseArrayMontageFileName, varargin{:});']...
            ['fitPupilPerimeter(correctedPerimeterFileName, pupilFileName,' ...
