...
% Nested function computes the objective
    function fval = objfun(x)
        ...
        % function. The inverse search is performed within a wrapper
        % function that uses a multi-start search if a local minimum in the
        % inverse solution is suspected.
