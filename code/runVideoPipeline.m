...
% estimateSceneParams routine. There is an associated path to a compiled
% ray tracing function
sceneGeometryFileNameOutput = fullfile(pathParams.dataOutputDirFull, [pathParams.runName '_sceneGeometry.mat']);
vitualImageFuncFileName = fullfile(pathParams.dataOutputDirFull, [pathParams.runName '_virtualImageFunc']);
...
switch p.Results.videoTypeChoice
    ...
    case 'LiveTrackWithVTOP_eye'
        funCalls = {...
            ...
            '''nSplits'', 0, varargin{:});']...
            ['estimateSceneParams(pupilFileName, sceneGeometryFileNameOutput,vitualImageFuncFileName,' ...
