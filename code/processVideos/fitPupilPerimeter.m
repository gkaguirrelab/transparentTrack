...
% many of the built-in image processing functions. This does not constitute
...
if ~p.Results.skipPupilBayes
    ...
    pupilData.meta.coordinatesSystem = 'intrinsicCoordinates(pixels)';
