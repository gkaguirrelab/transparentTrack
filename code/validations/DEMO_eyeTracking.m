...
sceneGeometry = createSceneGeometry(...
    ...
    'eyeLaterality','right','axialLength',25.35);
...
runVideoPipeline( pathParams, ...
    ...
    'sceneParamsLB',[-5; -5; -5; cameraDepthMean-cameraDepthSD*2; 0.75; 0.9],'sceneParamsUB',[5; 5; 5; cameraDepthMean+cameraDepthSD*2; 1.25; 1.1],'sceneParamsLBp',[-3; -2; -2; cameraDepthMean-cameraDepthSD*1; 0.85; 0.95],'sceneParamsUBp',[3; 2; 2; cameraDepthMean+cameraDepthSD*1; 1.15; 1.05],...
