...
switch p.Results.videoTypeChoice
    ...
    case 'LiveTrackWithVTOP_eye'
        funCalls = {...
            ...
            '''nSplits'', 0, varargin{:});']...
            'estimateSceneParams(pupilFileName, sceneGeometryFileNameOutput, ''glintFileName'', glintFileName, varargin{:});'...
            ['fitPupilPerimeter(correctedPerimeterFileName, pupilFileName,' ...
            '''sceneGeometryFileName'', sceneGeometryFileNameInput, ''relativeCameraPositionFileName'', relativeCameraPositionFileName, varargin{:});']...
            'smoothPupilRadius(correctedPerimeterFileName, pupilFileName, sceneGeometryFileNameInput, ''forceFreshFit'', true, ''relativeCameraPositionFileName'', relativeCameraPositionFileName, varargin{:});'...
            'smoothPupilRadius(correctedPerimeterFileName, pupilFileName, sceneGeometryFileNameInput, ''forceFreshFit'', false,  ''relativeCameraPositionFileName'', relativeCameraPositionFileName, varargin{:});'...
            ['makeFitVideo(grayVideoName, finalFitVideoName,' ...
    ...
    case 'gazeCalInfo_HighResWithDotTimes'
        funCalls = {...
            ['selectGazeCalFrames(pupilFileName, timebaseFileName, LTdatFileName, rawVidStartFileName, pupilCalInfoFileName, '...
            '''showPlots'', false, ''verbose'', true, ''plotFileName'', gazeCalFramesDiagnosticPlot, ' ...
            'varargin{:});']...
            };
    case 'syncSceneGeometry'
        funCalls = {...
