...
switch p.Results.videoTypeChoice
    ...
    case 'LiveTrackWithVTOP_eye'
        funCalls = {...
            ...
            'smoothPupilRadius(correctedPerimeterFileName, pupilFileName, sceneGeometryFileNameInput, ''relativeCameraPositionFileName'', relativeCameraPositionFileName, varargin{:});'...
            ['makeFitVideo(grayVideoName, finalFitVideoName,' ...
